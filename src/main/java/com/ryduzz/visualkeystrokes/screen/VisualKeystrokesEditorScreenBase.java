...
public abstract class VisualKeystrokesEditorScreenBase extends Screen implements VisualKeystrokesEditor {
    ...
    private void drawSidebar(DrawContext context, int mouseX, int mouseY) {
        ...
        for (Template template : filtered) {
            ...
            int entryColor = isPointInside(mouseX, mouseY, entryX, entryY, entryWidth, entryHeight)
                ...
                : (active ? UiStyle.BUTTON_ACTIVE : UiStyle.BUTTON_FILL);
    ...
    private void drawSettingsButton(DrawContext context, int mouseX, int mouseY) {
        ...
        int bgColor = hovered ? UiStyle.BUTTON_HOVER : UiStyle.BUTTON_FILL;
        ...
        context.drawTextWithShadow(textRenderer, gear, gearX, gearY, UiStyle.TEXT_PRIMARY);
    }
    ...
    private void drawSidebarToggle(DrawContext context, int mouseX, int mouseY) {
        ...
        context.fill(buttonX, buttonY, buttonX + buttonSize, buttonY + buttonSize, hovered ? UiStyle.BUTTON_HOVER : bgColor);
    ...
    private void drawHeader(DrawContext context, int mouseX, int mouseY) {
        ...
        context.fill(headerX - 8, headerY - 4, headerX + headerWidth + 8, headerY + headerHeight + 5, 0xA010141B);
        ...
        if (hovered || infoOpen) {
            ...
            context.drawHorizontalLine(headerX, headerX + headerWidth, underlineY, UiStyle.ACCENT_GOLD);
        }
    }
    ...
    private void drawInfoPopup(DrawContext context, int mouseX, int mouseY) {
        ...
        int closeBg = isPointInside(mouseX, mouseY, infoCloseX, infoCloseY, buttonWidth, buttonHeight) ? UiStyle.BUTTON_HOVER : UiStyle.BUTTON_FILL;
    ...
    private void drawResetButton(DrawContext context, int sidebarX, int sidebarWidth, int mouseX, int mouseY) {
        ...
        int bg = isPointInside(mouseX, mouseY, resetX, resetY, resetWidth, resetHeight) ? UiStyle.BUTTON_HOVER : UiStyle.BUTTON_FILL;
    ...
    private void drawSettingsRow(DrawContext context, String label, boolean enabled, int x, int y) {
        ...
        UiStyle.drawToggle(context, buttonX, y + 1, buttonWidth, buttonHeight, enabled, false);
    }
    ...
    private void drawEditorPopup(DrawContext context, int mouseX, int mouseY) {
        ...
        int closeBg = isPointInside(mouseX, mouseY, editorCloseX, editorCloseY, editorCloseWidth, editorCloseHeight) ? UiStyle.BUTTON_HOVER : UiStyle.BUTTON_FILL;
    ...
    private void drawTrashIcon(DrawContext context, Bounds bounds) {
        ...
        int outline = UiStyle.ACCENT_RED;
        int fill = UiStyle.PANEL_INSET;
        int lidHeight = 2;
    ...
    private void drawEditIcon(DrawContext context, Bounds bounds) {
        ...
        int color = UiStyle.ACCENT_GREEN;
